...
PICS = (environ.get('PICS', 'https://telegra.ph/Dboss-01-11 https://telegra.ph/Darshan-01-11 https://telegra.ph/Yash-01-11 https://telegra.ph/Sudeep-01-11 https://telegra.ph/Shiv-01-11 https://telegra.ph/Appu-01-11')).split()
 
# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002029301403').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'SPOfficialSupport')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "🎦 <b>File Name: </b> ➥  {file_caption} \n⚙️ <b>Size: </b><i>{file_size}</i>\n\n⚡<b>File uploaded by [SP FILTER BOT](https://t.me/Spmoviefilter_bot)</b>⚡\n\n   <b>Join Now [SP OFFICIAL MOVIES™](https://t.me/sp_offficial_movies)</b>🔥")
THUMBNAIL_URL = 'https://telegra.ph/Thumbnail-01-12-3'
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data by: @sp_officiaal_movies \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 \n\n♥️ we are nothing without you ♥️ \n\n💛 Please Share Us 💛\n\n⚠️Click on the button 👇 below to get your query privately")
LONG_IMDB_DESCRIPTION = is_enabled(environ.get("LONG_IMDB_DESCRIPTION", "False"), False)
SPELL_CHECK_REPLY = is_enabled(environ.get("SPELL_CHECK_REPLY", "True"), False)
MAX_LIST_ELM = environ.get("MAX_LIST_ELM", None)
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002029301403')).split()]
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Sharathp23') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','sp_official_movies') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','sp_official_movies') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','SPOFFICIALINFO')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "+OaQgwV3cym4yNTNI") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/sp_official_movies"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/sp_official_movies"
